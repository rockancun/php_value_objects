...
/**
 * Full name can't be empty and most be less than the assigned
 * space in the paper form 256 characters
 * Only letters and spaces are allowed.
 * Employee name can be empty until delivery date time.
 */
final class DeliveryEmployeeFullName extends TextNullable
{
